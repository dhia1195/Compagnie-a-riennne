...
public class Reclamation {
    ...
    public Reclamation(int id_reclamation, int id_user, String type_reclamation, String date, String description) {
    ...
    public Reclamation(int id_user, String type_reclamation, String date, String description) {
